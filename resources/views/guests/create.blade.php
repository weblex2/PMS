            ...
            <form action="/guests" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="nation1">
                        ...
                        @foreach($countryOptions as $code => $description)
                            <option value="{{ $code }}" {{ old('nation1') == $code ? 'selected' : '' }}>{{ $description }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="nation2">
                        <option value="">-- Land wählen --</option>
                        @foreach($countryOptions as $code => $description)
                            <option value="{{ $code }}" {{ old('nation2') == $code ? 'selected' : '' }}>{{ $description }}</option>
                        @endforeach
                    </select>
                </div>
