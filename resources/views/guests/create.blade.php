...
<head>
    ...
    <title>Gast erstellen - aiPms</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        input { width: 100%; padding: 12px 15px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px; }
        ...
        <div class="card">
            <form action="/guests" method="POST">
                ...
                <div class="btn-group">
                    ...
                    <a href="/guests" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Abbrechen</a>
                </div>
            </form>
        </div>
    </main>
