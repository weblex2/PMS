...
<body>
    ...
    <main class="main-content">
        <h1>Gaeste <a href="/guests/create" class="btn"><i class="fa fa-plus"></i> Hinzufuegen</a></h1>
        ...
        <div class="card">
            ...
            <table>
                <thead>
                    <tr><th>ID</th><th>Name</th><th>E-Mail</th><th>Telefon</th><th>Aktionen</th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $guest->phone ?: '-' }}</td>
                        <td class="actions">
                            <a href="/guests/{{ $guest->id }}/edit" class="btn btn-sm btn-edit"><i class="fa fa-pencil"></i></a>
                            <form action="/guests/{{ $guest->id }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-delete" onclick="return confirm('Gast wirklich loeschen?');"><i class="fa fa-trash"></i></button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
            ...
            @else
                <p style="color: #666;">Keine Gaeste vorhanden.</p>
            @endif
        </div>
    </main>
</body>
