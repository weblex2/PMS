    ...
    <main class="main-content">
        ...
        <div class="card">
            <form action="/prices" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="article_id" required>
                            ...
                            @foreach($articles as $article)
                                <option value="{{ $article->id }}">{{ $article->name }} ({{ $article->article_number }})</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="price_type" required>
                            <option value="selling">Verkaufspreis</option>
                            <option value="purchase">Einkaufspreis</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label>Notizen</label>
                    <textarea name="notes" rows="3" placeholder="Optionale Notizen..."></textarea>
                </div>
                
                <div style="margin-top: 20px;">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Preis anlegen</button>
