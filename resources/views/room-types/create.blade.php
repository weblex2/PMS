...
<head>
    ...
    <title>Neue Zimmerart - PMS</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group input, .form-group textarea { width: 100%; padding: 12px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 14px; transition: border-color 0.3s; }
        .form-group input:focus, .form-group textarea:focus { outline: none; border-color: #1e3a5f; }
        .form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
        
        .error-message { background: #fed color: #c7d7;53030; padding: 15px; border-radius: 8px; margin-bottom: 20px; }
            ...
            <form action="/room-types" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Name *</label>
                        <input type="text" name="name" placeholder="z.B. Doppelzimmer" required>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" rows="3" placeholder="Optionale Beschreibung..."></textarea>
                </div>
                
                <div style="margin-top: 20px;">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> Zimmerart anlegen</button>
                    <a href="/room-types" class="btn btn-secondary"><i class="fa fa-times"></i> Abbrechen</a>
                </div>
            </form>
        </div>
    </main>
