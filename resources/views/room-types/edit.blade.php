...
<head>
    ...
    <title>Zimmerart bearbeiten - PMS</title>
            ...
            <form action="/room-types/{{ $roomType->id }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="bed_count" min="1" value="{{ old('bed_count', $roomType->bed_count) }}" required>
                    </div>
                </div>
                
                <div class="form-group">
                    <label>Beschreibung</label>
                    <textarea name="description" rows="3">{{ old('description', $roomType->description) }}</textarea>
                </div>
