...
<head>
    ...
    <title>Zimmer erstellen - aiPms</title>
            ...
            <form action="/rooms" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="status" required>
                        <option value="free" {{ old('status') == 'free' ? 'selected' : '' }}>Frei</option>
                        <option value="occupied" {{ old('status') == 'occupied' ? 'selected' : '' }}>Belegt</option>
                        <option value="cleaning" {{ old('status') == 'cleaning' ? 'selected' : '' }}>Reinigung</option>
                    </select>
                </div>
                <div class="form-group">
